// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LegacyNuGetSettings.cs" company="WildGums">
...
namespace Orc.NuGetExplorer
{
    ...
    internal class LegacyNuGetSettings
    {
        #region Fields
        ...
        #region Constructors
        public LegacyNuGetSettings(IConfigurationService configurationService)
        {
        ...
        public IList<AddItem> GetNestedValues(string section, string subsection)
        {
            Argument.IsNotNullOrWhitespace(() => section);
        ...
        public void SetValues(string section, IList<AddItem> values)
        {
        ...
        public void UpdateSections(string section, IList<AddItem> values)
        {
        ...
        private IList<AddItem> GetNuGetValues(string section, bool isPath = false)
        {
            Argument.IsNotNullOrWhitespace(() => section);
